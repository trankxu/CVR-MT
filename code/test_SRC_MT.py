...
parser.add_argument('--root_path', type=str, default='/data/bitgroup/trankxu/code/SRC-MT/data/skin/ISIC2018_Task3_Training_Input/', help='dataset root dir')
parser.add_argument('--csv_file_train', type=str, default='/data/bitgroup/trankxu/code/SRC-MT/data/skin/training.csv', help='training set csv file')
parser.add_argument('--csv_file_val', type=str, default='/data/bitgroup/trankxu/code/SRC-MT/data/skin/validation.csv', help='validation set csv file')
parser.add_argument('--csv_file_test', type=str, default='/data/bitgroup/trankxu/code/SRC-MT/data/skin/testing.csv', help='testing set csv file')
...
### tune
parser.add_argument('--resume', type=str,  default='/data/bitgroup/trankxu/code/SRC-MT/model/xxxx/checkpoint/epoch_60.pth', help='Model to resume')
...
if __name__ == "__main__":
    ...
    for i in range(84,87):
        ...
        if args.resume:
            args.resume = "/data/bitgroup/trankxu/code/SRC-MT-Modify/model/xxxx/checkpoint/epoch_"+ str(i) + ".pth"
