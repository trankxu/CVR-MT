...
#######Chuankai Xu Change#############
class TransTwoStreams:
    def __init__(self, transformtwices_weak, transformtwices_strong):
        self.transformtwices_weak = transformtwices_weak
        self.transformtwices_strong = transformtwices_strong
        
    def __call__(self, img):
        stream1out = self.transformtwices_weak(img)
        stream2out = self.transformtwices_strong(img)
        return stream1out, stream2out
